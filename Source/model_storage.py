...
class storage4cluster():
    def __init__(self, model_name='',  user="", password="", database="", host_address='@@@.@@.@@@.@@\SQLEXPRESS01', port='1433'):
    ...
    def load_model_from_sql(self):
        ...
        model = cPickle.loads(str(sql_model[0]))
        return model
    ...
    def save_model_to_pkl(self, trained_model):
        ...
        backup_path = r'../Model_backup/' + self.model_name + '_' + strftime('%Y-%m-%d_%H-%M')
